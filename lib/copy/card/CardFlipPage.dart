...
import 'package:flutter_app/copy/card/CardData.dart';

class CardFlipPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {

    return _CardFlipState();
  }
}
...
class _CardFlipState extends State<CardFlipPage> {
  ...
  List<CardData> cardDataList = [
    CardData("assets/one.jpg", "江中树", "7 : 30", "AM", Icons.wb_sunny,
        "天府之地", "青山绿水"),
    CardData("assets/two.jpg", "浮云", "12 : 20", "PM", Icons.cloud, "天堂",
        "浮兰藏青"),
    CardData("assets/three.jpg", "路", "9 : 40", "AM", Icons.beach_access,
        "凡间", "平凡之路"),
    CardData("assets/four.jpg", "船", "16 : 30", "PM", Icons.brightness_2,
        "幽冥", "白云苍狗"),
  ];
...
class _CardFlipper extends State<CardFlipper> with TickerProviderStateMixin {
    ...
    finishScrollController = AnimationController(
      ...
      vsync: this,
        ...
        setState(() {
          ...
          if(scrollPercent < 1)widget.onScroll(scrollPercent);
  ...
  void _onHorizontalDragUpdate(DragUpdateDetails details) {
    ...
    setState(() {
      ...
      print("dragupdate + $scrollPercent");
    });
  }
        ...
        ClipRect(
          child: FractionalTranslation(
            ...
            child: ClipRRect(
              ...
              child: Image(
                image: AssetImage(widget.data.asset),
                fit: BoxFit.cover,
              ),
            ),
          ),
